...
public class PlaceShipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_ships2);


        findViewById(R.id.ll_ships).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.iv_carrier).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.iv_battleship).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.iv_destroyer).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.iv_cruiser).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.iv_submarine).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.bt_rotate).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.bt_random).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.bt_start).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
        findViewById(R.id.board).setLayoutDirection(View.LAYOUT_DIRECTION_LTR);


        mode = getIntent().getIntExtra("mode", GameSystem.MODE_VS_PLAYER);
        init();
    }
    ...
    private void init() {
        ...
        myApp.playMusic(MusicSoundHandlerApp.MUSIC_ID_PLACE);
    ...
    private void displayMessage(CharSequence message) {
        ...
        toast = Toast.makeText(PlaceShipsActivity.this, message, Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    private class ShipTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View touchedShip, MotionEvent touchEvent) {
            ...
            if (action == MotionEvent.ACTION_DOWN && !isDragging) {
                myApp.playSoundEffect(MusicSoundHandlerApp.SOUND_ID_PICKUP);
                ...
                touchedShip.startDragAndDrop(clipData, dragShadowBuilder, touchedShip, 0);
            ...
            switch (action) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (headCell != null && ivShip != null && board.placeShip(selectedShip, headCell)) {
                        // Play sound effect
                        myApp.playSoundEffect(MusicSoundHandlerApp.SOUND_ID_PLACE);
                        ...
                        myApp.playSoundEffect(MusicSoundHandlerApp.SOUND_ID_BLOCKED);
                        //Can't place ship
    ...
    private class StartListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(PlaceShipsActivity.this, GamePlayActivity.class);
