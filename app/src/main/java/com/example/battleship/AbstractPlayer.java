...
import static com.example.battleship.GameSystem.BATTLESHIP;
import static com.example.battleship.GameSystem.CARRIER;
import static com.example.battleship.GameSystem.CRUISER;
import static com.example.battleship.GameSystem.DESTROYER;
import static com.example.battleship.GameSystem.LOSE;
import static com.example.battleship.GameSystem.MISS;
import static com.example.battleship.GameSystem.NULL;
import static com.example.battleship.GameSystem.OPPONENT_DISCONNECTED;
import static com.example.battleship.GameSystem.READY;
import static com.example.battleship.GameSystem.SHOOT;
import static com.example.battleship.GameSystem.START;
import static com.example.battleship.GameSystem.SUBMARINE;
import static com.example.battleship.GameSystem.WAIT;
import static com.example.battleship.GameSystem.WIN;
...
public abstract class AbstractPlayer {
    ...
    public AbstractPlayer(String ip, int port, GamePlayActivity context, Board myBoard, Board opponentBoard) {
        ...
        this.myApp = (MusicSoundHandlerApp) context.getApplication();
        setUpNetwork();
    }
    ...
    final void checkCommand(String command) {
        ...
        switch (command) {
            case READY:
                ...
                break;
            case START:
                playSoundEffect(MusicSoundHandlerApp.SOUND_ID_GAME_START);
                break;
            case NULL:
            ...
            //Shoot result
            case MISS:
                playSoundEffect(MusicSoundHandlerApp.SOUND_ID_MISS);
            ...
            case SUBMARINE:
            case DESTROYER:
                playSoundEffect(MusicSoundHandlerApp.SOUND_ID_HIT);
                processShootResult(command);
                break;
